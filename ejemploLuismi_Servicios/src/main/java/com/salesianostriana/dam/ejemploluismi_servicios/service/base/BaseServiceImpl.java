...
import org.springframework.data.jpa.repository.JpaRepository;
									...
									//T = tipo de dato de la identidad, ID lo que lo caracteriza, R = tipo de dato del repositorio
									//Hay que especificar que R debe extender a JpaRepository con la misma T e ID
